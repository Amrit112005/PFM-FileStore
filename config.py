...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002010611899"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002168720966"))
...
try:
    ADMINS=[5733685945]
    for x in (os.environ.get("ADMINS", "5733685945").split()):
        ADMINS.append(int(x))
except ValueError:
